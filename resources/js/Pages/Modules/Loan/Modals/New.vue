            ...
            <div class="row customerform">
                ...
                <div class="col-md-12 mt-4">
                 ...
                 <div class="col-md-12 mt-3">
                   <div class="form-group">
                        <label>Role: <span class="text-muted">(optional)</span></label>
                        <input type="text" class="form-control" v-model="role" style="text-transform: capitalize;">
                    </div>
                </div>
                <div class="col-md-12 mt-3">
                   <div class="form-group">
                        <label>Contact: <span class="text-muted">(optional)</span></label>
                        <input type="text" class="form-control" v-model="contact" style="text-transform: capitalize;">
                    </div>
                </div>
                <div class="col-md-12">
