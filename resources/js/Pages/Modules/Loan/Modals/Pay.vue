<template>
    <b-modal v-model="showModal" title="Pay Loan" header-class="p-3 bg-light" class="v-modal-custom" modal-class="zoomIn" centered no-close-on-backdrop>    
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="avatar-sm bg-light rounded p-1 me-2"><img :src="currentUrl+'/images/avatars/avatar.jpg'" alt=""
